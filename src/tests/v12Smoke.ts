...
assert.equal(audit.evidenceEpoch.currentPolicyBattles, audit.metrics.battleFiles);
assert.equal(audit.evidenceEpoch.formalContextBattles, audit.metrics.battleFiles);
assert.equal(audit.evidenceEpoch.formalActivationReady, true);
