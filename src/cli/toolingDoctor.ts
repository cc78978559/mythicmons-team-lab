...
function aiPipelineStatus(directory: string): {available: boolean; healthy: boolean; researchComplete?: boolean; formalActivationReady?: boolean; nextStage?: string | null; warnings?: number} {
