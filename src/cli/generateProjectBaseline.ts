...
const packageJson = read<any>(packageFile), scripts = packageJson.scripts ?? {}, sourceFiles = [
  "src/ai/autonomousResearch.ts", "src/ai/formalValidation.ts", "src/ai/formalValidationPortfolio.ts", "src/ai/formalCanaryControl.ts", "src/ai/formalBattleCanaryAdapter.ts", "src/ai/semanticDecisionTrace.ts", "src/ai/pipelineControl.ts", "src/cli/autonomousResearch.ts", "src/cli/formalValidation.ts", "src/cli/formalCanaryControl.ts", "src/cli/aiPipeline.ts", "src/cli/toolingDoctor.ts", "src/draft/formalLeagueRuntime.ts", "src/draft/dynastyStateStore.ts", "src/draft/dynastyStorageMaintenance.ts",
];
