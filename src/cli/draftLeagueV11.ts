...
const env = {
  ...
  V4_EVOLUTION_MODE: process.env.V11_EVOLUTION_MODE || process.env.V4_EVOLUTION_MODE || "punctuated",
  V4_EVOLUTION_SHOCK: process.env.V11_EVOLUTION_SHOCK || process.env.V4_EVOLUTION_SHOCK || "0",
  V4_EVOLUTION_MAX_BURSTS: process.env.V11_EVOLUTION_MAX_BURSTS || process.env.V4_EVOLUTION_MAX_BURSTS || "2",
