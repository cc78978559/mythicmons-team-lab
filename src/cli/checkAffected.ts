...
function mappedImpact(testFile: string, changedFile: string): boolean {
  ...
  const impacts: Record<string, string[]> = {
    ...
    "src/ai/positionValue.ts": ["positionValueContractSmoke.ts"],
    "src/ai/relationalCounterfactual.ts": ["relationalCounterfactualContractSmoke.ts"],
    "src/ai/relationalValidation.ts": ["relationalValidationContractSmoke.ts"],
    "src/ai/formalSemanticDiagnostics.ts": ["formalSemanticDiagnosticsSmoke.ts"],
    "src/ai/semanticHypothesisRevision.ts": ["semanticHypothesisRevisionSmoke.ts"],
    "src/ai/postHocSemanticDescendants.ts": ["postHocSemanticDescendantsSmoke.ts"],
    "src/ai/tieredResearchEvidence.ts": ["tieredResearchEvidenceSmoke.ts"],
