...
const env = {
  ...
  V4_LINEUP_ASSIST_APPROVAL: process.env.V12_LINEUP_ASSIST_APPROVAL || process.env.V4_LINEUP_ASSIST_APPROVAL || "",
  V4_TACTICAL_MEMORY_BEHAVIOR_POLICY: process.env.V12_TACTICAL_MEMORY_BEHAVIOR_POLICY || process.env.V4_TACTICAL_MEMORY_BEHAVIOR_POLICY || "cumulative",
  V4_TACTICAL_MEMORY_CONFIDENCE_FLOOR: process.env.V12_TACTICAL_MEMORY_CONFIDENCE_FLOOR || process.env.V4_TACTICAL_MEMORY_CONFIDENCE_FLOOR || ".15",
  V4_COUNTERFACTUAL_CONTINUATION: process.env.V12_COUNTERFACTUAL_CONTINUATION || "false",
  V4_CONTINUATION_SALT: process.env.V12_CONTINUATION_SALT || "",
