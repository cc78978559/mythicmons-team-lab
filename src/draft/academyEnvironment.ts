...
function compactTradition(profile: ManagerProfile): ManagerProfile { const copy = cloneManagerProfile(profile); copy.matchupMemory = {}; copy.configurationMemory = {moves: {}, items: {}}; copy.tacticalMemory = undefined; copy.tacticalMemoryExperiment = undefined; copy.development.styleHistory = []; return copy; }
